...
Status note: the journey passes end to end with copy generated by the fact-only
copywriter; image, graphic and video generation join it as their adapters land.
